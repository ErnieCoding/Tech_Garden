...
#define EMERGENCY_BTN_GPIO_Port GPIOC
#define EMERGENCY_BTN_EXTI_IRQn EXTI15_10_IRQn
...
#define JOY_SW_Pin GPIO_PIN_14
#define JOY_SW_GPIO_Port GPIOD
#define JOY_SW_EXTI_IRQn EXTI15_10_IRQn
